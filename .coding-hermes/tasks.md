...
- [x] Test: provider failure mid-call (retry with backoff, fallback to LM Studio) — 463e841 (7 tests: error types, context-limit retry, documented gaps: HTTP retry, provider fallback, circuit breaker wiring)
