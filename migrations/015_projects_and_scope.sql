-- ============================================================================
-- Conscience — 015_projects_and_scope.sql
-- ============================================================================
...
--
-- axiom:trace work_item=WI-migration-015-fix
...
-- 2. Add project_id to sessions for scope propagation.
-- (001_initial_schema did not include this column; added here.)
...
-- SPEC-015 §4.1.
--
-- Wrapped in a DO $$ block so SQLite silently skips the entire section
-- (filterForSQLite strips DO blocks; the EXCEPTION clause is belt-and-suspenders).
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Skipping Postgres triggers (non-Postgres backend): %', SQLERRM;
END $$;
