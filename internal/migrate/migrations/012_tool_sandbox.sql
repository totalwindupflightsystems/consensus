...
--    NOTE: SQLite doesn't support ALTER TABLE DROP CONSTRAINT. This migration
--    skips the constraint rewrite on SQLite — the Go runtime enforces status
--    values at the application level. PostgreSQL path (commented out below)
--    would drop and recreate the CHECK constraint:
