// init command — bootstrap a new Conscience instance.
//
...
func newInitCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "init",
		Short: "Bootstrap a new Conscience instance",
		Long: `Bootstrap a new Conscience instance with database tables, default
